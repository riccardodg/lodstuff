...
class LreMapConfAPI(object):
    __CONFTAB__="START_conferences"
    ...
    def fetchData(self):
        ...
        query="SELECT * FROM "+ self.__CONFTAB__ + ";"
        if (self.verbose==1):
            print "LREMAP CONF APIs: Executing "+name  +" and query "+query
